...
<body>
	...
	<div id="container">
			<main>
				<header><span style="text-align:center;color:black;font-size:25px;"><h1>NOWOŚCI:</h1></span></header>
					<div class="proposed">
						<?php
				...
				<span style="color:black;color:#636363;"><h1 style="font-size:50px;">Co ten żuk wyprawia?...</h1></span>
				<span style="text-align:center; line-height:60px;">
					
						Od dziecka drzemie we mnie zamiłowanie do piękna, sztuki i rękodzieła.<br>
						Uwialbiam otaczać się przedmiotami cieszącymi oko...<br>
						...jednak jeszcze większą radość daje mi podzielenie się moją twórczością z innymi.<br>
						Zapraszam do mnie w poszukiwaniu prezentów i upiększania codzienności.<br>

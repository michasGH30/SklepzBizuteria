...
<header>
	...
	<div id="container">
		...
		<label>Tytuł: <input type="text" name="title" placeholder="TYTUŁ" required></label>
		<br>
		<label>Cena: <input type="number" name="price" step="0.01" required></label>
		<br>
		 <label>Ilość: <input type="number" name="number" required></label>
		 <br>
		 <label>Dostępny: <input type="checkbox" name="available" value="Yes" required></label>
		 <br>
		 ...
		 <option value="cufflinks">Spinki</option>
		 <option value="earrings">Kolczyki</option>
		 <option value="necklace">Naszyjniki</option>
		 <option value="brooch">Broszki</option>
		 <option value="pictures">Obrazy</option>
		 <option value="napkins">Serwetki</option>
		 <option value="hoops">Tamborki</option>
		 <option value="handicraft">Rękodzieło</option>
		 </select></label>
		 <br>
		 <textarea name="description" rows="30" cols="50" placeholder="OPIS">
		 </textarea>
		 <br>
